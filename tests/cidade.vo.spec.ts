...
import { InvalidCidadeException } from "../src/exceptions/cidade.exceptions";
...
describe("Cidade", () => {
  ...
  it("deve lançar um erro para nome de cidade inválido", () => {
    expect(() => new Cidade(" ")).toThrow(InvalidCidadeException);
    expect(() => new Cidade("AB")).toThrow(InvalidCidadeException);
  });
